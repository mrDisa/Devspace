...
from communities.views import CommunityDetailAPIView, CommunityJoinAPIView, CommunityLeaveAPIView, CommunityListCreateAPIView, CommunityMemberKickAPIView, CommunityMemberListAPIView, CommunityMemberRoleAPIView
